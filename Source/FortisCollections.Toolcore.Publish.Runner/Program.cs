...
namespace FortisCollections.Toolcore.Publish.Runner
{
    internal class Program
    {
        ...
        {
            WriteMessage("------------------------");
            WriteMessage("Toolcore - Publish (3.0) - Sitecore Publishing Service and Legacy Service Compatible. SC 9.3. Last Updated Date : 23-March-2021");
            WriteMessage("------------------------");
        ...
        private static void RunPublish(Options options)
        {
